...
As an algorithm developer you can access the data you need from your S3 account in a few easy steps. This guide will tell you how to configure and connect to your data source and provide details about setting various permissions.
...
def s3_data():
    ...
    # Open file from your S3 bucket
    with open(cf, 'r') as f:
        file_data = csv.reader(f, delimiter=',')
        for row in file_data:
            # Print out your csv's data
            print(row)
...
def apply(input):
    # Print input that you pass in as an argument
    print(input)
    return data
