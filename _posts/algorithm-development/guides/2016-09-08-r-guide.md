...
algorithm <- function() {
  ...
  client$file("data://demo/demo/data.csv")$putFile(tempLocation)
}
{% endhighlight %}
...
* <a href="http://developers.algorithmia.com/clients/R language/">Algorithmia Client R language Docs <i class="fa fa-external-link"></i></a>