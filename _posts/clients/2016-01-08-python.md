...
Next, retrieve your API key from the Credentials tab under MyProfile after you've logged in to [Algorithmia](https://algorithmia.com/).
...
This guide will show how to work with the [Hosted Data Source](https://algorithmia.com/data/hosted) option on the Algorithmia platform which is available to both algorithm and application developers.
...
For more information on collection-based Access Control Lists (ACLs) go to the [Hosted Data Guide](http://developers.algorithmia.com/application-development/data-sources/hosted-data-guide/).
...
For more information on data collection permissions check out [Hosted Data Source](http://developers.algorithmia.com/application-development/data-sources/hosted-data-guide/).
