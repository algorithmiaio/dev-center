...
The Algorithmia Java Client is published to Maven central and can be added as a library through Maven using your IDE of choice or you can download the JAR file and add it as a dependency in your POM file:
...
For more information on the methods available using the Data API in Java check out the [Data API](http://docs.algorithmia.com/) documentation or the [Java Client Docs](https://github.com/algorithmiaio/algorithmia-java.git).
