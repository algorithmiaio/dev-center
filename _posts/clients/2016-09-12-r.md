...
For more information on the methods available using the Data API in R check out the [Data API](http://docs.algorithmia.com/) documentation or the [R Client Docs](https://github.com/algorithmiaio/algorithmia-r.git).
