...
Here you will learn how to install the Algorithmia Android Client, work with the Data API by uploading and downloading files, create and update directories and permission types and last, you'll learn how to call an algorithm that summarizes text files.

To follow along you can create a new Java file in your IDE for Android.
...
For API documentation, see the [Algorithmia API docs](http://docs.algorithmia.com/?java#)
...
**Note:** If you want to follow along and don't wish to upload the file programatically you can upload <a href="/data_assets/burning_daylight.txt">Chapter One Burning Daylight, by Jack London</a> file to your data collection `nlp_directory` by navigating to your [Hosted Data](https://algorithmia.com/data/hosted) and dragging and dropping the file into `nlp_directory`.
