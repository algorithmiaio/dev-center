...
var text_file = "jack_london_burning_daylight.txt";

nlp_directory.file(text_file).get(function(err, data) {
	if (err){
...
For more information on the methods available using the Data API in Node check out the [Data API](http://docs.algorithmia.com/) or the [Algorithmia Node.js Client](https://github.com/algorithmiaio/algorithmia-nodejs)
...
var client = algorithmia("simA8y8WJtWGW+4h1hB0sLKnvb11");

var nlp_directory = client.dir("data://.my/nlp_directory");
...
var local_file = "/Users/stephaniekim/desktop/jack_london_burning_daylight.txt";
