...
The official Algorithmia Go Client is available on [GitHub](https://godoc.org/github.com/algorithmiaio/algorithmia-go).
...
For more information on the methods available using the Data API in Go check out the [Data API](http://docs.algorithmia.com/) documentation or the [Go Client Docs](https://github.com/algorithmiaio/algorithmia-go.git).
