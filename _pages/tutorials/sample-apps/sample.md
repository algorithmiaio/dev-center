...
* [The Algorithmia Java Client]({{site.baseurl}}/clients/java)
* [Algorithmia Java Client API Docs](https://www.javadoc.io/doc/com.algorithmia/algorithmia-client) <i class="material-icons">open_in_new</i>
