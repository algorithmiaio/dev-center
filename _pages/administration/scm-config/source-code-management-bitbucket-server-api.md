...
For example, in the code [below](#creating-a-bitbucket-server-scm-configuration), for `-H 'Authorization: Simple|Bearer CLUSTER_ADMIN_AUTH_TOKEN'` you'd use one or the other of the following commands, replacing the placeholders as appropriate:
