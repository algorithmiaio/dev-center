...
via the <a href="{{ site.baseurl }}/developers/clients/scala">Algorithmia & Scala</a>.
...
* <a href="{{ site.baseurl }}/developers/clients/java">Algorithmia Client Java Docs <i class="fa fa-external-link"></i></a>
