...
via the <a href="/application-development/client-guides/scala/">Algorithmia & Scala</a>.
...
To call other algorithms or manage data from your algorithm, use the <a href="/application-development/client-guides/scala/">Algorithmia & Scala</a> which is automatically available to any algorithm you create on the Algorithmia platform. For more detailed information on how to work with data see the [Data API docs](http://docs.algorithmia.com/) and learn about Algorithmia's [Hosted Data Source](/developers/data/).
...
* <a href="/clients/java/">Algorithmia Client Java Docs <i class="fa fa-external-link"></i></a>
