...
<images-section>
  <image-popout>
    <img src="{{site.cdnurl}}{{site.baseurl}}/images/post_images/algo_dev_lang/algorithm_console_Javascript.png" alt="Algorithm console JavaScript" class="syn-image-responsive">
  </image-popout>
</images-section>
