...
You can also upload your data through the UI on Algorithmia's [Hosted Data Source]({{ site.baseurl }}/data/). For instructions on how to do this go to the [Hosted Data Guide]({{ site.baseurl }}/data/hosted/).
