...
### Getting Set Up
 ...
 7. Start the test server: `bundle exec jekyll serve` (append `--config _config.yml,_config-dev.yml` to use dev cdn config; to simulate an enterprise deploy, also add `_config-enterprise.yml`)
